...
import DailyWorklogsTableSet from 'App/Client/Features/Worklogs/LoggerScene/DailyWorklogsTableSet';
...
const WorklogForm = () => (
    <Grid>
        <Row>
            ...
            <Col md={ 3 }>
                <div className="vspaced-children-10" style={{ marginTop: '18px' }}>
